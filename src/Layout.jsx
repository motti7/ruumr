        ...
        <div className="sm:hidden">
            ...
            {shouldShowNav && (
                <header className="bg-white dark:bg-gray-800 sticky top-0 z-50 border-b border-gray-200 dark:border-gray-700" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
                    <div className="max-w-md mx-auto px-2 h-16 flex items-center justify-center relative">
                        <div className="absolute left-2 flex items-center gap-0">
                        ...
                        <Link to={createPageUrl("Discover")} className="select-none flex items-center h-full">
