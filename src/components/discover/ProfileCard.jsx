  ...
  return (
    <motion.div
      ...
      aria-label={`פרטים מלאים של ${profile.name}`}>
            ...
            <button
        onClick={onClose}
        className="fixed top-14 left-6 z-[300] p-4 rounded-full bg-white shadow-2xl hover:bg-gray-100 transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
          ...
          <>
            ...
            <div className="absolute bottom-32 left-4 z-20 flex flex-col items-start gap-2">
              ...
              <span key={interest} className="bg-black/60 backdrop-blur-sm px-3 py-1.5 rounded-full text-white text-xs font-medium border border-white/20">
                        ...
                        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/60 to-transparent p-5 pointer-events-none pb-35">
