...
export default function ProfileCard({ profile, onSwipe, isActive }) {
    ...
    useEffect(() => {
        ...
        // Logic changed: Play only when on 2nd photo (index 1) OR if there are no photos and we are active
        // But the requirement is specifically "starts playing when moving to the second picture"
        
        let shouldPlay = false;
        
        // Logic: 
        // 1. If we have media, play only if currentPhotoIndex === 1
        // 2. If we DON'T have media (unlikely but possible), maybe play immediately? Assuming we have photos.
        
        // Wait, the media array calculation is below this effect in the original file. 
        // But currentPhotoIndex is available.
        
        // We need to know if index 1 is actually the second photo. Yes.
        ...
        if (shouldPlay) {
            ...
            audio.pause();
            // Optional: reset current time if we want to restart every time
