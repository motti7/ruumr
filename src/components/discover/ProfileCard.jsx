            ...
            >
                ...
                >
                    ...
                    {profile.song_preview_url && profile.song_name && isActive && (
                        <div className="absolute top-20 left-2 z-20 flex items-center gap-3 bg-black/60 backdrop-blur-md p-2 pl-4 rounded-full border border-white/10 animate-in fade-in slide-in-from-bottom-4 duration-700">
