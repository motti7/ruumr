  ...
  return (
    <motion.div
      ...
      aria-label={`פרטים מלאים של ${profile.name}`}>
            ...
            <button
        onClick={onClose}
        className="fixed bottom-8 left-6 z-[300] min-w-[44px] min-h-[44px] flex items-center justify-center"
        aria-label="סגור פרטים">
        
                <X className="text-white w-8 h-8 drop-shadow-lg" strokeWidth={2.5} />
            </button>
