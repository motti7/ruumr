...
export default function ProfileCard({ profile, onSwipe, isActive }) {
    ...
    useEffect(() => {
        ...
        // Only play if active AND on the second photo (index 1)
        // Use logical index logic: if video exists, index 1 might be different, 
        // but typically index 1 is the second slide.
    ...
    }, [isActive, profile.song_preview_url, currentPhotoIndex]);
