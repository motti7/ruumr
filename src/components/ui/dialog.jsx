...
const Dialog = /** @type {any} */ (DialogPrimitive.Root)

const DialogTrigger = /** @type {any} */ (DialogPrimitive.Trigger)

const DialogPortal = /** @type {any} */ (DialogPrimitive.Portal)

const DialogClose = /** @type {any} */ (DialogPrimitive.Close)
