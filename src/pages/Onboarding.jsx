...
<AnimatePresence mode="wait">
  ...
  <motion.div
    ...
    className="w-full flex flex-col h-full">
        ...
        {title && <h2 className="text-3xl text-center mt-5 mb-3 py-1" style={{ color: '#FA3803', fontFamily: "'Google Sans', 'Inter', sans-serif", fontWeight: 'bold' }}>{title}</h2>}
  ...
  useEffect(() => {
    const trackStep = async () => {
      try {
        ...
        return true;default:return true;}};const nextStep = () => {const currentStep = step;const stepName = STEP_NAMES[currentStep] || `Step ${currentStep}`;trackMixpanel('Registration Step Completed', { step_number: currentStep, step_name: stepName });if (step === 3 && formData.current_status === 'seeking_apartment') {
        ...
        <div className="flex-1 relative">
                ...
                <>
                  ...
                  <div className="flex items-center gap-2 text-gray-500">
                    ...
                    className="h-11 text-base bg-gray-50 border-gray-200 focus:border-[--theme-orange] focus:ring-0 focus-visible:ring-0" />
                        ...
                        <div className="flex flex-col gap-1 text-right">
                            <label className="font-bold text-s" style={{ color: '#FA3803' }}>מגדר</label>
                            <CustomSelect
                    ...
                    <div className="pt-1 text-right">
                        <label className="text-sm font-bold block mb-4 py-1 mt-1" style={{ color: '#FA3803' }}>מה הוויב שלך?</label>
                        <Slider
                  dir="ltr"
            ...
            <Step step={3} currentStep={step} title="העדפות">
                <div className="space-y-3 text-right">
                    {/* אני מחפש/ת */}
                    <div>
                        <label className="text-sm font-bold block py-1 my-1" style={{ color: '#FA3803' }}>אני מחפש/ת</label>
                ...
                { v: 'haredi', l: 'חרדי/ת' }]
                    ...
                    {/* חיית מחמד */}
                    <div>
                        <label className="text-sm font-bold block my-2 py-1" style={{ color: '#FA3803' }}>חיית מחמד שמצטרפת?</label>
