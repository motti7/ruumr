...
<AnimatePresence mode="wait">
  ...
  <motion.div
    ...
    className="w-full flex flex-col h-full">
        ...
        {title && <h2 className="text-3xl text-center py-1 mt-5 mb-3" style={{ color: '#FA3803', fontFamily: "'Google Sans', 'Inter', sans-serif", fontWeight: 'bold' }}>{title}</h2>}
  ...
  useEffect(() => {
    const trackStep = async () => {
      try {
        ...
        return true;default:return true;}};const nextStep = () => {const currentStep = step;const stepName = STEP_NAMES[currentStep] || `Step ${currentStep}`;
