...
const INTEREST_OPTIONS = [
  ...
  { id: "pilates", label: "פילאטיס", Icon: UserIcon, color: "bg-teal-50 text-teal-700 border-teal-200" },
  { id: "yoga", label: "יוגה", Icon: EyeOff, color: "bg-teal-50 text-teal-700 border-teal-200" },
  { id: "soccer_basketball", label: "כדורגל / כדורסל", Icon: Trophy, color: "bg-green-50 text-green-700 border-green-200" },
  { id: "motorcycles", label: "אופנועים", Icon: Zap, color: "bg-gray-100 text-gray-700 border-gray-300" },
  ...
  { id: "painting", label: "ציור", Icon: Palette, color: "bg-pink-50 text-pink-700 border-pink-200" },
  ...
  { id: "concerts", label: "הופעות", Icon: Mic, color: "bg-purple-50 text-purple-700 border-purple-200" },
  ...
  { id: "travel", label: "טיולים", Icon: Plane, color: "bg-sky-50 text-sky-700 border-sky-200" },
  { id: "art", label: "אמנות", Icon: Palette, color: "bg-pink-50 text-pink-700 border-pink-200" },
  { id: "fitness", label: "כושר", Icon: Dumbbell, color: "bg-orange-50 text-orange-700 border-orange-200" },
  ...
  { id: "tech", label: "טכנולוגיה", Icon: Laptop, color: "bg-cyan-50 text-cyan-700 border-cyan-200" },
  { id: "fashion", label: "אופנה", Icon: Shirt, color: "bg-rose-50 text-rose-700 border-rose-200" },
  { id: "pets", label: "חיות מחמד", Icon: PawPrint, color: "bg-orange-50 text-orange-700 border-orange-200" },
  { id: "netflix", label: "נטפליקס", Icon: Tv2, color: "bg-red-50 text-red-700 border-red-200" },
  { id: "hosting", label: "אירוח חברים", Icon: PartyPopper, color: "bg-purple-50 text-purple-700 border-purple-200" },
  { id: "homebody", label: "נשאר/ת בבית", Icon: Home, color: "bg-slate-100 text-slate-700 border-slate-300" },
